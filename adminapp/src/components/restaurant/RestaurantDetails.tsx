  ...
  return (
    <div class="px-4 py-5 sm:p-6">
      ...
      <div class="border-t pt-8">
        <div class="mb-6">
          <h3 class="text-lg font-medium text-gray-900 mb-4">Restaurant Management</h3>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <a
              href={`/restaurants/${props.restaurant.id}/tables`}
            ...
            >
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  <h4 class="text-sm font-medium text-gray-900">Tables & QR Codes</h4>
                  <p class="text-sm text-gray-500">Manage tables and generate QR codes</p>
                </div>
              </div>
            </a>
