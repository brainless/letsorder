...
function OrderDashboard() {
  ...
  const [viewMode, setViewMode] = createSignal<'all' | 'today' | 'table'>('today');
    ...
    <div class="p-6">
        ...
        <div class="mb-6">
          ...
          <Show when={restaurants.currentRestaurant}>
            <p class="text-gray-600 mt-1">{restaurants.currentRestaurant?.name}</p>
          </Show>
        </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd class="text-lg font-medium text-gray-900">{orders.stats?.total_orders || 0}</dd>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd class="text-lg font-medium text-gray-900">{formatCurrency(orders.stats?.total_revenue || 0)}</dd>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd class="text-lg font-medium text-gray-900">{orders.stats?.pending_orders || 0}</dd>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd class="text-lg font-medium text-gray-900">{formatCurrency(orders.stats?.average_order_value || 0)}</dd>
                    </dl>
                  </div>
                </div>
              </div>
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-6">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select 
                value={viewMode()} 
                onChange={(e) => setViewMode(e.currentTarget.value as 'all' | 'today' | 'table')}
            ...
            <div>
              ...
              <select 
                value={statusFilter()} 
                onChange={(e) => setStatusFilter(e.currentTarget.value as OrderStatus | '')}
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                          ...
                          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              <p class="text-sm text-gray-600">
                                <span class="font-medium">Table:</span> {order.table_name}
                              </p>
                            ...
                            <div>
                              ...
                              <p class="text-sm text-gray-600">
                                <span class="font-medium">Total:</span> {formatCurrency(order.total_amount)}
                              </p>
                            </div>
                            
                            <div class="flex items-center space-x-2">
                              <Show when={getStatusOptions(order.status).length > 0}>
                                <select
                                  onChange={(e) => handleStatusUpdate(order.id, e.currentTarget.value as OrderStatus)}
