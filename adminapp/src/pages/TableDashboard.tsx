...
function TableDashboard() {
  ...
  const getPageDescription = () => {
    switch (viewMode()) {
      case 'create':
        return 'Add a new table to your restaurant';
      case 'edit':
        return 'Update table information';
      case 'qr':
        return 'View and print QR code for table';
      case 'bulk-qr':
        return 'Generate QR codes for multiple tables';
      case 'print':
        return 'Print-ready QR codes';
      default:
        return 'Manage tables and QR codes for your restaurant';
    }
  };
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center">
          <div>
            ...
            <p class="mt-2 text-gray-600">{getPageDescription()}</p>
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-width="2"
                    d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 005 0z"
                  ></path>
                </svg>
                Bulk QR
              </button>
        ...
        <div class="mb-6 rounded-md bg-red-50 p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <div class="mt-2 text-sm text-red-700">{table.error}</div>
            </div>
      ...
      <div class="bg-white shadow rounded-lg">
        ...
        >
          <Show when={viewMode() === 'list'}>
            ...
            >
              <TableList onEdit={handleEdit} onShowQR={handleShowQR} />
            </Show>
          </Show>
